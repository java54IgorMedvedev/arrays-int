...
int [] array = {10, 25, 30, 40, 100};
	...
	void binarySearchIntTest() {
	    ...
	    assertEquals(-1, Arrays.binarySearch(sortedArray, 5)); 
	    assertEquals(0, Arrays.binarySearch(sortedArray, 10)); 
	    assertEquals(4, Arrays.binarySearch(sortedArray, 50)); 
	    assertEquals(-6, Arrays.binarySearch(sortedArray, 55)); 
	}
